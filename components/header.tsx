      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Button variant="ghost" className="hover:bg-accent/20" onClick={handleGoogleSignIn}>
              <User className="w-4 h-4 mr-2" />
              Login
            </Button>
            <Button className="relative bg-gradient-to-r from-orange-400 to-orange-500 hover:from-orange-500 hover:to-orange-600 text-white px-6 py-2 rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-orange-400/25 overflow-hidden group">
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-16 left-0 right-0 bg-background/95 backdrop-blur-md border-b border-border animate-slide-in-up">
            <nav className="flex flex-col space-y-4 p-4">
              ...
              <Link href="/courses" className="text-foreground hover:text-primary transition-colors duration-200 py-2">
                Courses
              </Link>
              ...
              <Link href="/pricing" className="text-foreground hover:text-primary transition-colors duration-200 py-2">
                Partner & Price
              </Link>
              <Link href="/contact" className="text-foreground hover:text-primary transition-colors duration-200 py-2">
                Contact
              </Link>
              <div className="flex flex-col space-y-2 pt-4 border-t border-border">
                <Button variant="ghost" className="justify-start hover:bg-accent/20" onClick={handleGoogleSignIn}>
                  <User className="w-4 h-4 mr-2" />
                  Login
                </Button>
