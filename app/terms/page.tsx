...
export default function TermsOfServicePage() {
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-transparent overflow-scroll scrollbar-hide">
            <main className="min-h-screen flex align-top justify-center items-start bg-transparent container mx-auto px-4 sm:px-6 lg:px-8 py-16 mt-16 overflow-y-auto scrollbar-hide">
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.5 }}
                    className="max-w-6xl h-fit mx-auto rounded-2xl shadow-xl border border-border p-8 space-y-8 bg-transparent top-0"
                >
                    ...
                    <section className="prose dark:prose-invert max-w-none space-y-6">
                        <p>
                            Welcome to NEXT4LEARN! These Terms of Service ("Terms") govern your access to and use of the NEXT4LEARN website, products, and services ("Services"). By accessing or using our Services, you agree to be bound by these Terms.
                        </p>
                        ...
                        <p>
                            All content provided on NEXT4LEARN, including text, graphics, logos, images, and software, is the property of NEXT4LEARN or its content suppliers and protected by international copyright laws.
                        </p>
                        ...
                        <p>
                            The Services are provided on an "AS IS" and "AS AVAILABLE" basis. NEXT4LEARN makes no warranties, expressed or implied, and hereby disclaims all other warranties.
                        </p>

                        <h2>8. Limitation of Liability</h2>
                        <p>
                            In no event shall NEXT4LEARN, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from (i) your access to or use of or inability to access or use the Service; (ii) any conduct or content of any third party on the Service; (iii) any content obtained from the Service; and (iv) unauthorized access, use or alteration of your transmissions or content, whether based on warranty, contract, tort (including negligence) or any other legal theory, whether or not we have been informed of the possibility of such damage, and even if a remedy set forth herein is found to have failed of its essential purpose.
                        </p>
