    ...
    courseStructure: [
      ...
      },
      {
        ...
        lessons: [
          ...
          { title: "Initial Configuration - Set up basic files and folders", duration: "15 mins", completed: false },
        ],
      },
      {
            ...
            <Card className="sticky top-24" data-aos="fade-up" data-aos-delay="500">
              ...
              <CardContent className="p-6 space-y-6">
                <div className="text-center">
                  ...
                  <Button
                    size="lg"
                    className="w-full bg-gradient-to-r from-orange-400 to-orange-500 hover:from-orange-500 hover:to-orange-600 text-white mb-3"
                  >
                    Enroll Now
                  </Button>
